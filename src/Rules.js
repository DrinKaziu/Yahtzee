...
const threeOfKind = new SumDistro({ count: 3, description: 'Sum of all dice for 3 of a kind' });
const fourOfKind = new SumDistro({ count: 4, description: 'Sum of all dice for 4 of a kind' });

// full house scores as flat 25
const fullHouse = new FullHouse({ score: 25, description: 'Score 25 for a full house' });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30, description: 'Score 30 for a small straight' });
const largeStraight = new LargeStraight({ score: 40, description: 'Score 40 for a large straight' });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50, description: 'Score 50 for a yahtzee' });
